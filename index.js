...
function createMenuItem(name, price, category){
    const reservation = {name: name, price: price, category: category}
    return reservation;
}
...
console.log(createMenuItem('Chili', 6, 'Lunch'));
console.log(createMenuItem('Tacos', 15, 'Dinner'));
console.log(createMenuItem('Cheese Fries', 8, 'Lunch'));
